...
// 获取待处理任务
router.get('/:extensionId/tasks', (req, res) => {
...
// 接收任务完成结果
router.post('/:extensionId/tasks/:taskId/complete', (req, res) => {
...
// 获取扩展配置和数据
router.get('/:extensionId/data', (req, res) => {
    const { extensionId } = req.params;
...
// 接收扩展发送的数据
router.post('/:extensionId/data', (req, res) => {
    const { extensionId } = req.params;
