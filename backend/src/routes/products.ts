...
import { ProductService, type ProductQueryOptions, type CreateProductData, type UpdateProductData, process1688Products } from '../services/productService.js';
import { type I1688ProductData } from '../models/Product.js';
...
router.get('/', async (req: Request, res: Response) => {
  try {
    const options: ProductQueryOptions = {
      ...
      ...(req.query.status && { status: req.query.status as 'active' | 'inactive' | 'out_of_stock' }),
      ...
      ...(req.query.sortBy && { sortBy: req.query.sortBy as 'createdAt' | 'price' | 'name' | 'rating.average' }),
...
router.post('/import/1688', async (req, res) => {
  try {
    const products: I1688ProductData[] = req.body.products || req.body;
