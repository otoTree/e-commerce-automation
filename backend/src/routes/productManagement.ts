 ...
 * GET /api/products
 */
const getProducts = async (req: Request<{}, ProductResponse, {}, ProductQuery>, res: Response<ProductResponse>) => {
  try {
    const {
      platform,
      category,
      ...
      page = 1,
      limit = 20,
      sort = '-collection_meta.collected_at'
    } = req.query;
 ...
 */
const getProductById = async (req: Request<{ productId: string }>, res: Response<ProductResponse>) => {
  try {
 ...
 */
const updateProduct = async (req: Request<{ productId: string }>, res: Response<ProductResponse>) => {
  try {
    const { productId } = req.params;
    ...
    const updatedProduct = await ProductFullData.findByIdAndUpdate(
      productId,
      { $set: updateFields },
 ...
 * POST /api/products
 */
const createProduct = async (req: Request<{}, ProductResponse, any>, res: Response<ProductResponse>) => {
  try {
 ...
 */
const deleteProduct = async (req: Request<{ productId: string }>, res: Response<ProductResponse>) => {
  try {
    const { productId } = req.params;
 ...
 */
const getProductStatistics = async (req: Request, res: Response<ProductResponse>) => {
  try {
    const [
      totalProducts,
      platformStats,
 ...
 */
const batchDeleteProducts = async (req: Request<{}, ProductResponse, { product_ids: string[] }>, res: Response<ProductResponse>) => {
  try {
